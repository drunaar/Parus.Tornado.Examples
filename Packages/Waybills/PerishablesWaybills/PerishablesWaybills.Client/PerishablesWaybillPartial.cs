...
namespace Acme.Business.Waybills.PerishablesWaybills
{
	...
	{
		/// <summary>
		/// Все точки раздела <seealso cref="PerishablesWaybillUnit"/>
		/// </summary>
		public static class Points
		{
			...
			/// <summary>
			/// Точка маршрута для скоропортящихся грузов
			...
			/// <summary>
			/// Путевые листы для скоропортящихся грузов
			/// Обозреватель
			/// </summary>
		...
		/// <summary>
		/// Все переходы <seealso cref="PerishablesWaybillUnit"/>
		/// </summary>
